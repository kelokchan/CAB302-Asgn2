...
public abstract class Customer {
	 ...
	 * @throws CustomerException if supplied parameters are invalid such as:
	 * 				1. Name is empty or longer than 20
	 * 				2. Mobile no. length is not 10 or does not start with 0
	 * 
	 */
